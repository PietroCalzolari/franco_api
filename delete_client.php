<?php
$id = $_GET["id"];
$url = "https://servizi.wpschool.it/wp-json/wc/v3/customers/" . $id;
...
if ($response === false) {
    ...
    print_r('Ho eliminato il cliente ' . $id);
    header("Location: https://wpschool.it/gestionalewoo/calzolari/clienti.php");
}
